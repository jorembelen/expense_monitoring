                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mt-4">
                                <h5>Use this credential to Login</h5>
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <div>
                            <p>© <script>document.write(new Date().getFullYear())</script> DLPS. Coded with <i class="mdi mdi-heart text-danger"></i> by <a href="https://joreb.net" target="_blank" rel="noopener noreferrer">JOREB</a></p>
                        </div>
                    </div>
